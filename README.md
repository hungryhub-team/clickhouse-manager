...
| Name                   | Github                          | Role        |
| ---------------------- | -------------------------------- | ----------- |
| Rahmat Ramadhan Putra  | https://github.com/rahmatrdn      | Contributor |
| Saiqul Haq             | https://github.com/saiqulhaq      | Contributor |
...
1. Clone this repo
```sh
git clone https://github.com/hungryhub-team/clickhouse-manager.git
```
